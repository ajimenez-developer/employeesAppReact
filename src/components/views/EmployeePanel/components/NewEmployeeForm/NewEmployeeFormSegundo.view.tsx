...
class NewEmployeeFormSegundoView extends React.Component<Props & FormikProps<any>, State> {
  render() {
    return (
      <Form>
        <Label htmlFor="name">
        ...
        {sentence.surname} 
          <Input required name="surname" type="text" placeholder={sentence.surname} 
...
export default NewEmployeeFormSegundoView